...
\begin{document}
	...
	\section{Capítulo 1. Descripción del curso y desarrollo de la práctica docente}
	...
	\begin{itemize}
		...
		\item Análisis y aplicación del primer examen parcial con uso de GeoGebra.
		\item Funciones polinomiales y su graficación.
		\item Aplicaciones de funciones polinomiales.
		\item Funciones racionales: dominio, asíntotas e intersecciones.
		\item Funciones exponenciales y logarítmicas.
		\item Trigonometría: leyes de senos, cosenos y tangente.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Desarrollo de liderazgo, empatía y comunicación asertiva en el proceso educativo.
	\end{itemize}
