...
\begin{document}
	...
	pagecommand={\thispagestyle{empty}}, % (opcional) número de página visible
...
pagecommand={\thispagestyle{empty}}, % ← sin número de página
