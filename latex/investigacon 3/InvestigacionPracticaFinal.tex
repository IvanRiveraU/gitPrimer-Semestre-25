...
\end{itemize}
	...
	\subsubsection{Normas guatemaltecas (AGIES – NSE)}
	- \textbf{NSE 7.4 (Mampostería reforzada)}: Establece la necesidad de refuerzo vertical en las jambas y mochetas. Define que las soleras deben ser continuas a nivel de losas, dinteles y coronas, para asegurar el amarre. Obliga a que las mochetas en vanos (puertas y ventanas) estén confinadas y con barras ancladas a cimentaciones.  
	- \textbf{NSE 2 (Cargas y demandas sísmicas)}: Regula las solicitaciones mínimas de carga y las aceleraciones sísmicas que deben considerarse en la mampostería. Garantiza que los elementos no colapsen de forma frágil.  
	- \textbf{NSE 1 (Generalidades)}: Indica que todos los elementos constructivos deben cumplir con condiciones de seguridad y servicio durante la vida útil.  
	...
	[1] Aceros Torices. Catálogo de productos. Aceros Torices (ATSA), s/f. Consultado el 25 de julio de 2021.
	
	
	[2] Mabasa.  ¿Qué es la losacero? Mabasa, 2019. Consultado el 25 de julio de 2021.
	
	
	[3] SEO Aceroform. ¿Qué es el losacero? Aceroform, s/f. Consultado el 25 de julio de 2021.
	
	
	[4] Ternium. Manual de Instalación Ternium Losacero. Ternium, 2020. Consultado el 25 de julio de 2021.
