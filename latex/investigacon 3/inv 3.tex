...
\geometry{margin=1in}
 ...
 % PAQUETE PAR LAS IMAGENES
 
 \graphicspath{{./Imagenes}}
 

%CONFIGURACION DE MI PAGINA:
\usepackage{fancyhdr}
\pagestyle{fancy}
...
\usepackage{enumitem}   % para listas multinivel (numeración + incisos + viñetas)
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{Imagenes/losa1}
...
\end{figure}
	...
	\section{Encofrado y apuntalamiento}
	...
	\begin{enumerate}
		...
		\item \textbf{Metálico}
		\begin{enumerate}[label=\alph*)]
			\item Más durable que la madera, resistente a repetidos usos.
			\item Requiere limpieza y pintura anticorrosiva.
		\end{enumerate}
